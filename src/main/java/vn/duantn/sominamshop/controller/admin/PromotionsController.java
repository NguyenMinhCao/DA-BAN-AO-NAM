...
//    private PromotionsRepository promotionsRepository;
    ...
    public String hienThiKM(@RequestParam(defaultValue = "0", name = "page") Integer number, Model model){
        ...
        Page<Coupon> listKM = promotionRepository.findAll(pageable);
        model.addAttribute("khuyenMaiRequest",new Coupon());
...
//    ADD
    ...
    public String add(Coupon promotion) {
...
//VIEW
    ...
    public String viewUpdateKM(@PathVariable("id") Long id, Model model) {
        Coupon promotion = promotionRepository.findById(id).get();
...
//UPDATE
    ...
    public String update(Coupon promotion) {
        promotionRepository.save(promotion);
        return "redirect:/hien-thiKM";
    }
}
