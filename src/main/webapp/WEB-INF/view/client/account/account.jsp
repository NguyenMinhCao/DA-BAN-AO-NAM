                            ...
                            <div class="col-md-9" style="height: 450px;">
                                <div class="card">
                                    <div class="card-body" style="height: 450px;">
                                        ...
                                        <hr>
                                        <form:form class="d-flex" method="post" modelAttribute="userUpdate">
                                            <div class="">
                                                ...
                                                <fieldset class="mb-3">
                                                    ...
                                                    <div class="form-check form-check-inline">
                                                        <input class="form-check-input" type="radio" name="gender"
                                                            id="male" value="true" name="gender">
                                                        <label class="form-check-label" for="male">Nam</label>
                                                    </div>
                                                    <div class="form-check form-check-inline">
                                                        <input class="form-check-input" type="radio" name="gender"
                                                            id="female" value="false" name="gender">
                                                ...
                                                <div class="TJWfNh">
                                                    <div class="nMPYiw" role="header">
                                                        <label for="file-input" class="cW0oBM"
                                                            style="background-image: url('/images/avatar/${userUpdate.avatar}')"></label>
