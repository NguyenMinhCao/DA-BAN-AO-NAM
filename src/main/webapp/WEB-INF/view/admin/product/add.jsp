    ...
    <div class="row">
        <div class="col-md-12">
            <div class="tile">
                    ...
                    <form class="row">
                        ...
                        <div class="form-group col-md-3">
                            ...
                            <div class="d-flex">
                                ...
                                <button id="showFormMaterial" class="btn add-button" type="button"><i class="fa-solid fa-plus fa-2xl add-icon"></i></button>
                            </div>
                        </div>
                ...
                <button class="btn btn-save" type="button" onclick="showListProductDetail()">Danh sách biến thể</button>
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="tile">
                ...
                <button class="btn btn-primary btn-sm edit" type="button" id="quick_edit">Chỉnh sửa nhanh <i class="fas fa-edit"></i></button>
                <div class="tile-body">
                    <form class="row">
                        <div class="form-group col-md-12">
