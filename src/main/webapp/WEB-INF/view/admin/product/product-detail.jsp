                    ...
                    <main class="content">
                        <div class="app-title">
                            <ul class="app-breadcrumb breadcrumb side">
                                <li class="breadcrumb-item active"><a href="#"><b>Danh Sách Biến Thể Sản Phẩm</b></a>
                                </li>
                            </ul>
                            <div id="clock"></div>
                        </div>
                            ...
                            <div class="col-md-12">
                                <div class="tile">
                                    ...
                                    <div class="tile-body">
                                        <form class="row">
                                            ...
                                            <div class="col-md-12">
                                                ...
                                                <label id="product-id"
                                                    data-product-id="${product.id}">${product.id}</label>
                                            </div>
                                                ...
                                                <div class="d-flex row-quantity">
                                                    <div class="col-md-2 color-quantity">
                                                        <select class="form-control" id="select-size-quantity"
                                                            ...
                                                            <option value="" disabled selected hidden>Chọn kích thước
                                                            </option>
                                    ...
                                    <a class="btn btn-cancel"
                                        href="${pageContext.request.contextPath}/admin/product">Quay lại</a>
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="tile">
                                    <div class="tile-body">
                                        <div class="row element-button">
                                            <div class="col-sm-2">
                                                <a class="btn btn-add btn-sm" id="showFormProductDetailAdd"
                                                    title="Thêm"><i class="fas fa-plus"></i> Tạo mới</a>
                                            </div>
                                        </div>

                                        <!-- Modal Update Biến Thể -->
                                        <div class="modal fade" id="UpdateProductDetailModal" tabindex="-1"
                                        ...
                                        <div class="modal fade" id="AddProductDetailModal" tabindex="-1" role="dialog"
                                            ...
                                            <div class="modal-dialog" role="document">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="row modal-body">
                                                        <div class="form-group col-md-6">
                                                            ...
                                                            <div class="d-flex">
                                                                ...
                                                                <button id="showFormColor" class="btn add-button"
                                                                    type="button"><i
                                                    ...
                                                    <div class="form-group modal-footer">
                                                        <button type="button" class="btn btn-success"
                                                            onclick="saveAdd()">Lưu</button>
                                                        <button type="button" class="btn btn-secondary"
                                                            data-dismiss="modal"
                                                            id="closeFormProductDetailAdd">Đóng</button>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
