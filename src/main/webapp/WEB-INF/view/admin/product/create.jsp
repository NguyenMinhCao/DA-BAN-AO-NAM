                ...
                <div class="container mt-5">
                    <div class="row">
                        <div class="col-md-6 col-12 mx-auto">
                            ...
                            <form:form class="row g-3" method="post" action="/admin/product/create-product" modelAttribute="newProduct" enctype="multipart/form-data">
                                <!-- Name -->
                                <div class="col-md-6">
                                    <label class="form-label">Name:</label>
                                    <form:input type="text" class="form-control ${newBindingResult.hasFieldErrors('name') ? 'is-invalid' : ''}" path="name" />
                                ...
                                <div class="col-md-12">
                                    ...
                                    <input class="form-control" type="file" id="avatarFiles" name="getImgFiles" accept=".png, .jpg, .jpeg" multiple />
                                </div>
