                    ...
                    <div class="tile">
                        <div class="tile-body">
                            <div class="row element-button mb-3">
                                <div class="col-sm-2">
                                    <a class="btn btn-add btn-sm" href="${pageContext.request.contextPath}/admin/product/add" id="showFormAdd" title="Thêm">
                                    ...
                                    <div class="modal-content">
                                        ...
                                        <div class="row modal-body">
                                            ...
                                            <div class="form-group col-md-12">
                                                ...
                                                <textarea class="form-control ckeditor" id="product-description"></textarea>
                                            </div>
                                        </div>
                                        <div class="form-group modal-footer">
                                            <button type="button" class="btn btn-success" onclick="save()">Lưu</button>
                                            <button type="button" class="btn btn-secondary" data-dismiss="modal" id="closeFormProduct">Đóng</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <table class="table table-hover table-bordered js-copytextarea" cellpadding="0" cellspacing="0" border="0" id="sampleTable">
                                ...
                                <c:forEach var="product" items="${lists}" varStatus="status">
                                    <tr>
                                        <td class="stt">${status.index + 1}</td> <!-- Sử dụng status.index để lấy chỉ số của vòng lặp -->
                                        <td class="ten_san_pham">${product.name}</td>
                                        <td class="anh"><img src="/images/product/${product.image}" alt="Hình ảnh sản phẩm"></td>
