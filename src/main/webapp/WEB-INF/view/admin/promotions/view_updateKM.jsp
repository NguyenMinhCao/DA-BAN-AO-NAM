                        ...
                        <div class="col-md-6 col-12 mx-auto">
                            ...
                            <form modelAttribute="promo" action="/hien-thiKM" method="get">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="discountType" class="form-control" value="${promo.discountType}" readonly>
<%--                                    <form:errors path="discountType"/>--%>
                                </div>
                                <br>
                                <div class="form-group">
                                    <b class="bi bi-key-fill"> <label>Start Date</label></b>
                                    <input type="text" name="startDate" class="form-control" value="${promo.startDate}" readonly>
<%--                                    <form:errors path="startDate"/>--%>
                                </div>
                                <br>
                                <div class="form-group">
                                    <b class="bi bi-person-arms-up"> <label>End Date</label></b>
                                    <input type="text" name="endDate" class="form-control" value="${promo.endDate}" readonly>
...
<%--                                        <input class="form-check-input" type="radio" name="status" id="1" value="1">--%>
                                    ...
                                    <div class="form-check">
<%--                                        <input class="form-check-input" type="radio" name="status" value="0" ${promo.status == "0" ? "checked" : "">--%>
