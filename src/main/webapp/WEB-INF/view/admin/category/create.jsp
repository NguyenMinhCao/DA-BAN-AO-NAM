    ...
    <div id="layoutSidenav_content">
        <main>
            <div class="container-fluid px-4">
                <h1 class="mt-4 text-dark">Thêm danh mục</h1>
                                ...
                                <div class="card-body">
                                    ...
                                    <form:form method="post" action="/admin/category/create"
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <form:input type="text" class="form-control ${newBindingResult.hasFieldErrors('categoryName') ? 'is-invalid' : ''}"
                                        ...
                                        <div class="d-flex justify-content-between">
                                            ...
                                            <a href="/admin/category" class="btn btn-warning">
