                        ...
                        <div class="col-md-8">
                            <div class="card shadow-sm">
                                ...
                                <div class="card-body">
                                    ...
                                    <form:form method="post" action="/admin/size/create"
                                               modelAttribute="newSize" enctype="multipart/form-data">
                                        <div class="mb-3">
                                            <label class="form-label"> :</label>
                                            <form:input type="text" class="form-control ${newBindingResult.hasFieldErrors('sizeName') ? 'is-invalid' : ''}"
                                                        path="sizeName" placeholder="Enter sizeName name"/>
                                            <form:errors path="sizeName" cssClass="invalid-feedback"/>
                                        </div>
                                        ...
                                        <div class="d-flex justify-content-between">
                                            ...
                                            <a href="/admin/size" class="btn btn-warning">
