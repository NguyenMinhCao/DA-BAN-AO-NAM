                ...
                <nav class="sb-sidenav accordion sb-sidenav-dark" id="sidenavAccordion">
                    <div class="sb-sidenav-menu">
                        <div class="nav">
                            ...
                            <!-- ..... -->
                            <a class="nav-link collapsed" href="#" data-bs-toggle="collapse"
                                data-bs-target="#collapseLayoutsCustomer" aria-expanded="false" aria-controls="collapseLayoutsCustomer">
...
<%--                                    <a class="nav-link collapsed" href="/admin/customer" data-bs-toggle="collapse"--%>
